...
module.exports = {
    ...
    .setName('user-info')
    .setDescription('Gets the info of a given user.')
    .addUserOption(option => option.setName('user').setDescription('The user you want the info of.').setRequired(false)),
    async execute(interaction) {
        ...
        await interaction.reply({ embeds: [userbed]});
    }
}